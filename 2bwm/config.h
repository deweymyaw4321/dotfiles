...
///--Menus and Programs---///
static const char *term[] = {CMD, NULL };
static const char *scrot[] = {"~/bashProg/scrotNoDelay", NULL };
static const char *scrotDelay[] = {"~/bashProg/scrotDelay", NULL };
static const char *ranger[] = {CMD,"-e", "ranger", NULL };
static const char *browser[] = {"/usr/bin/chromium", NULL };
static const char *steam[] = {"/usr/bin/steam-native", NULL };
...
static key keys[] = {
	...
	{  MOD ,			  XK_p,			 start,				{.com = scrot}},
	{  MOD |SHIFT,		  XK_p,			 start,				{.com = scrotDelay}},
	{  MOD ,			  XK_e,			 start,				{.com = ranger}},
	{  MOD ,			  XK_s,			 start,				{.com = steam}},
